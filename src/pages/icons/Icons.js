...
export default function IconsPage () {
  ...
  return (
  <>
    <PageTitle title="آیکون ها" button={(
      <>
        <Button
      variant="contained"
      size="medium"
    ...
    >
      ...
      onClose={handleClose}
    >
      <MenuItem onClick={handleClose}><Icons.Print style={{marginRight: 16}}/> پرینت </MenuItem>
      <MenuItem onClick={handleClose}><Icons.GetApp style={{marginRight: 16}}/> دانلود</MenuItem>
      <MenuItem onClick={handleClose}><Icons.Email style={{marginRight: 16}}/>ارسال با ایمیل</MenuItem>
          <MenuItem onClick={handleClose}><Icons.Share style={{marginRight: 16}}/>اشتراک گذاری</MenuItem>
    </Menu>
      </>
    )} />
